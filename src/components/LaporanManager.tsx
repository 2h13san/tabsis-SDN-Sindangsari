...
export const LaporanManager: React.FC<LaporanManagerProps> = ({
  ...
  const [reportMode, setReportMode] = useState<'matriks_fisik' | 'jurnal_transaksi'>('matriks_fisik');
  ...
  // Compute Matrix Ledger Data per Student
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-4 no-print">
        <div>
          <h2 className="text-xl font-black text-slate-900 flex items-center gap-2">
            ...
            <span>Laporan Rekapitulasi Tabungan Siswa Per Kelas</span>
          </h2>
          <p className="text-xs text-slate-500 mt-0.5">
            Format resmi matriks setoran harian bulanan per kelas (Format Ledger Fisik Sekolah) & Jurnal.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex p-1 bg-slate-100 rounded-xl">
            ...
            >
              ...
              <span>Matriks Buku Fisik Kelas</span>
            </button>
            <button
          ...
          <button
            ...
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
          >
      ...
      {/* REPORT VIEW AREA */}
      {reportMode === 'matriks_fisik' ? (
        /* MATRIKS PENERIMAAN TABUNGAN BULAN (FORMAT BUKU LEDGER FISIK) */
        <div
          id="printable-report"
        ...
        >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[11px] border-collapse border border-slate-900 font-mono">
              ...
              <tbody className="divide-y divide-slate-300">
                ...
                {/* Pad empty rows if student count < 20 to match physical ledger sheet feel */}
          ...
          <div className="pt-8 flex justify-between text-xs font-semibold px-4">
            ...
            <div className="text-right">
              <p>
                {settings.alamat.split(',')[0] || 'Sekolah'},{' '}
